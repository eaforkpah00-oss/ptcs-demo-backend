...
const auditLogSchema = new mongoose.Schema({
  ...
  // null for system-triggered writes (webhooks, cron jobs) with no acting user
...
auditLogSchema.statics.record = function ({ school, user = null, action, targetId = null, targetType = null, metadata = {} }) {
